<template>
  <q-page class="q-pa-md seller-dashboard-page">
    ...
    <div class="sd-top-section row justify-end">
      ...
      <q-btn color="red" :icon-right="config.buttonTop.icon[1]" :label="config.buttonTop.text[1]"
...
.top-button:hover,
.sd-top-section :deep(.q-btn:hover) {
...
/* Subtle active press */
.top-button:active,
.sd-top-section :deep(.q-btn:active) {
...
:deep(.stock-cell .q-field__label) {
  color: #f8fafc;
}
